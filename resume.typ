...
#show: resume.with(
  author: "Isaiah Thomas Conway",
  location: "New Braunfels, TX and Hong Kong, China
  | US Citizen | Texas State Resident | Hong Kong Right to Work |",
  contacts: (
    [#link("+852 8493 0851")],
    [#link("mailto:itconway@connect.ust.hk")],
    [#link("linkedin.com/in/isaiahconway2112")],
  ),
...
#edu(
  ...
  date: "Jun. 2028 (ongoing)",
  location: "Hong Kong, Clear Water Bay",
  degrees: (
    ("BEng", "Aerospace Engineering (ongoing)"),
  ),
)

#edu(
  institution: "International School of Tianjin (IB)",
  date: "May 2024",
  degrees: (
    ("High School Diploma", "IB: 43/45"),
...
- _Full tuition merit scholarship to the Hong Kong University of Science and Technology_
- Hong Kong Construction Industry Safety Training Certificate (“Green Card”)
- Hong Kong NOL (No-Objection Letter)
...
#exp(
  role: "Lineman",
  project: "SimplyFLY Flight School",
  date: "July - August 2026",
  summary: "Worked as a part-time Lineman at the New Braunfels Municipal Airport, TX, United States",
  details:[
    - Roles included cleaning, refueling, towing and general maintenance of Remos GX and G3 aircraft
  ]
)

= Projects
#exp(
  role: link("https://www.imdb.com/title/tt0088763/")[FSAE Rear Wing Design],
  project: "HKUST Red Bird Racing Team",
  date: "October - December 2025",
  summary: "FSAE rear wing module obeying legality requirements designed using SolidWorks",
  details: [
    - Designed a formula student rear wing, producing over 200N of downforce at 50 km/h.
    - Consisting of a main wing, flap wing and endplates, airfoils chosen using real-world data.
  ]
)

// #exp(
//   role: "Front Wing Optimization",
//   project: "HKUST Red Bird Racing Team",
...
#exp(
  role: "UAV Wing Design",
  project: "",
  date: "July 2026 - (ongoing)",
  summary: "Designing a wing from the ground up for a fixed wing disaster reconnaissance UAV",
  details:[
    - Studied UAV design through online videos and lectures
    - Designing airfoil, wing and producing polars through XFLR5
    - Structural design and FEA testing using SolidWorks, CFD using SimScale
  ]
)
...
#exp(
  ...
  project: "HKUST School of Engineering",
  date: "August 2025 - June 2026",
  summary: "Providing academic advice and consultation to first year undergraduates",
  details: [
    - Assisting school of engineering freshmen plan out their current and future classes.
  ]
)

#exp(
  role: "Aircraft Engineering Development Scheme",
  project: "HAECO, HKIE, RAeS",
  date: "February 2026 - (ongoing)",
  summary: "Accelerated pathway to receiving the HKAR-66 Aircraft Maintenance license",
  details: [
    - Mentorship from experienced engineers, technical visits, on-the-job training and meeting industry professionals. 
    - Self-guided learning, lectures and study groups assist in studying for the license exams. 
